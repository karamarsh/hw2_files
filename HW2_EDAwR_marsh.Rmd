...
The full data set has NA values in Income, Income Error, and Child Poverty columns
...
```{r histo_lt2.5m}
ggplot(data = county_df, aes(x = Income, y = ..density..)) + geom_histogram(fill = "Blue") + labs(title = "Distribution of population for US counties", x ="Total Population", y = "Number of counties") + geom_density()

smaller <- county_df %>%
  filter(TotalPop < 2500000)

ggplot(data = smaller, aes(x = Income, y = ..density..)) + geom_histogram(fill = "blue") + labs(title = "Distribution of non-outlier population for US counties", x ="Total Population", y = "Number of counties") + geom_density()
```
...
ggplot(data = county_MI) + geom_boxplot(aes(y = Income, x = peninsula)) + 
  labs(title = "Distribution of income by peninsula", y = "Median Income", x = "Peninsula")
```
...
ggplot(data = county_MI) + geom_boxplot(aes(y = Native, x = peninsula)) + 
  labs(title = "Percent of population that is Native American by peninsula", y = "Native American %", x = "Peninsula")
```
...
poverty by peninsula is nearly the same, just under 25%.
